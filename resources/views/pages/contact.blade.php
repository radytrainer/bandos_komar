...
<section class="bg-bk-navy py-24 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10 text-center">
        <span class="text-bk-orange font-bold uppercase tracking-widest text-sm mb-4 block">Contact Us</span>
        <h1 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight leading-tight">
            We Are Always <br> <span class="text-bk-orange">Here to Help</span>
        </h1>
        <p class="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Reach out to us through the form below or visit our office. We look forward to connecting with you.
        </p>
    </div>
</section>
                    ...
                    <form action="#" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" placeholder="Your Name" class="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-bk-orange focus:ring-4 focus:ring-bk-orange/10 outline-none transition-all font-semibold">
                            </div>
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Email</label>
                                <input type="email" placeholder="Your Email" class="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-bk-orange focus:ring-4 focus:ring-bk-orange/10 outline-none transition-all font-semibold">
                            </div>
                        </div>
                        <div class="space-y-2">
                            <label class="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Subject</label>
                            <input type="text" placeholder="What is this about?" class="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-bk-orange focus:ring-4 focus:ring-bk-orange/10 outline-none transition-all font-semibold">
                        </div>
                        <div class="space-y-2">
                            <label class="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Message</label>
                            <textarea rows="4" placeholder="Your message..." class="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-bk-orange focus:ring-4 focus:ring-bk-orange/10 outline-none transition-all font-semibold resize-none"></textarea>
                        </div>
