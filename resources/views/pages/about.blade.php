    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div class="max-w-2xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="#"
                    class="bg-bk-orange text-white px-10 py-4 rounded-full font-extrabold text-lg shadow-lg hover:scale-105 hover:shadow-bk-orange/40 transition-all text-center">
                    Our Programs
                </a>

                <a href="#"
                    class="bg-transparent text-white px-10 py-4 rounded-full font-extrabold text-lg border-2 border-white hover:bg-white hover:text-bk-navy transition-all text-center">
                    Learn More
                </a>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-surface-container-low p-10 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="w-14 h-14 bg-bk-blue/10 rounded-xl flex items-center justify-center mb-6">
                    <span class="material-symbols-outlined text-bk-blue text-3xl">
                        visibility
                    </span>
                </div>

                <h3 class="font-headline-md text-headline-md text-bk-navy mb-4">
                    Vision
                </h3>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div class="p-6 rounded-xl border border-slate-100 bg-surface-muted text-center hover:bg-white hover:shadow-lg transition-all">
                ...
                <div class="font-bold text-bk-navy mb-2">
                    {{ $value['title'] }}
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="group relative bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100">
                    ...
                    <div class="p-8">
                        ...
                        <p class="font-body-md text-body-md text-text-muted mb-6">
