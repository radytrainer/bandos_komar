...
<section class="bg-bk-navy py-20 relative overflow-hidden">
    <div class="container mx-auto px-4 md:px-6 relative z-10">
        <h1 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">{{ $page->translated_content['header']['title'] ?? 'Publications' }}</h1>
...
<section class="py-24 bg-white">
    <div class="container mx-auto px-4 md:px-6">
        <div class="space-y-6">
            @if(isset($page->translated_content['items']))
                @foreach($page->translated_content['items'] as $item)
