...
<section class="bg-bk-navy py-20 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10 text-center">
        <div class="max-w-3xl mx-auto">
            <span class="text-bk-orange font-bold uppercase tracking-widest text-sm mb-4 block">Make an Impact</span>
            <h1 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">Support Our Mission</h1>
            <p class="text-gray-300 text-lg md:text-xl leading-relaxed">
                Your generosity empowers children and transforms communities. Choose how you want to make a difference today.
            </p>
        </div>
    </div>
</section>
