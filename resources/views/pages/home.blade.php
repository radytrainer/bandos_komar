...
<section class="py-24 bg-gray-50">
    <div class="container mx-auto px-4 md:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            @if(isset($page->translated_content['programs']))
                @foreach($page->translated_content['programs'] as $program)
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10">
        <div class="bg-bk-navy rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden group">
            ...
            <div class="relative z-10 max-w-3xl mx-auto">
                <h2 class="text-4xl md:text-6xl font-black text-white mb-8 leading-tight tracking-tight">{{ $page->translated_content['cta']['title'] ?? 'Support Our Mission' }}</h2>
                <p class="text-gray-300 text-xl mb-12 leading-relaxed">
                    {{ $page->translated_content['cta']['description'] ?? '' }}
                </p>
