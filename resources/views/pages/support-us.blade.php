...
<section class="bg-bk-navy py-20 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10 text-center">
        <div class="max-w-3xl mx-auto">
            <span class="text-bk-orange font-bold uppercase tracking-widest text-sm mb-4 block">Get Involved</span>
            <h1 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">Support Us</h1>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white relative">
    <div class="container mx-auto px-4 md:px-6 text-center">
        ...
        <p class="text-gray-500 max-w-xl mx-auto text-lg leading-relaxed">
            This page is currently being drafted. We are working on providing you with all the details on how you can support our mission.
        </p>
    </div>
</section>
@endsection
